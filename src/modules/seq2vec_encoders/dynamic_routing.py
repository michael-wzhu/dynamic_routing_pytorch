...
@Seq2VecEncoder.register("dynamic_routing_aggregator")
class DynamicRoutingAggregator(Seq2VecEncoder):
    """
    ...
    def __init__(self, input_dim: int,
                 ...
                 activation_function: str = "tanh") -> None:
        ...
        # TODO: here it could be pointwise_feed_forword
